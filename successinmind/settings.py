"""
Django settings for successinmind project.
...
ROOT_URLCONF = 'successinmind.urls'
...
WSGI_APPLICATION = 'successinmind.wsgi.application'
...
AUTHENTICATION_BACKENDS = ('home.authenticate.EmailBackend',)
